...
class ListsControllerTest < ActionController::TestCase
  ...
  context 'with an admin user' do
    setup do
      login_as :admin # default org is :one
      @list = lists(:org_two_list)
    end

    should "change default org for admin user to current_list's org" do
      get :show, id: @list.id
      assert_template 'show'
      assert @login_user.reload.default_organization_id == @list.organization_id
    end
